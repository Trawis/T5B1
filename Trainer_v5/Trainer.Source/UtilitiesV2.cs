...
{
	public static class UtilitiesV2
	{
		...
		public static Button CreateLabel(UnityAction action, string title, string name)
		{
		...
		public static Button CreateInputBox(UnityAction action, string title, string name)
		{
			var button = WindowManager.SpawnButton();
			button.GetComponentInChildren<Text>().text = title;
			button.onClick.AddListener(action);
		...
		public static Button CreateButton(UnityAction action, string title, string name)
		{
			var button = WindowManager.SpawnButton();
			button.GetComponentInChildren<Text>().text = title;
			button.onClick.AddListener(action);
		...
		public static Button CreatToggle(UnityAction action, string title, string name)
		{
			var button = WindowManager.SpawnButton();
			button.GetComponentInChildren<Text>().text = title;
			button.onClick.AddListener(action);
